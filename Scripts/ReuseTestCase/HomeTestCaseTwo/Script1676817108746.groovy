...
WebUI.callTestCase(findTestCase('ReuseTestCase/LoginTestCaseOne'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'This is a comment section')
